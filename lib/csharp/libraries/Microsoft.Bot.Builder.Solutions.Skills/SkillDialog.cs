...
namespace Microsoft.Bot.Builder.Solutions.Skills
{
    ...
    public class SkillDialog : ComponentDialog
    {
            ...
            : base(skillConnectionConfiguration.SkillOptions.Id)
        {
            ...
            _skillConnector = SkillConnectorFactory.Create(skillConnectionConfiguration.SkillOptions, skillConnectionConfiguration.ServiceClientCredentials, telemetryClient);
        }
